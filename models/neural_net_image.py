...
# Implementations are based off of TensorFlow's very own example: [TensorFlow Neural Network Tutorial](https://www.tensorflow.org/tutorials/keras/classification)
import time
